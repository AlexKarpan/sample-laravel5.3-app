...
<div class="container">
    ...
    {!! Form::model($booking, [
        ...
        <div class="form-group {{ $errors->has('city_id') ? 'has-error' : ''}}">
            {!! Form::label('city_id', 'City Id', ['class' => 'col-sm-3 control-label']) !!}
            <div class="col-sm-6">
        ...
        <div class="form-group {{ $errors->has('starts_at') ? 'has-error' : ''}}">
            ...
            <div class="col-sm-6">
                {!! Form::date('starts_at', $booking->starts_at, ['class' => 'form-control']) !!}
                {!! $errors->first('starts_at', '<p class="help-block">:message</p>') !!}
            </div>
        </div>
        <div class="form-group {{ $errors->has('ends_at') ? 'has-error' : ''}}">
            {!! Form::label('ends_at', 'Ends At', ['class' => 'col-sm-3 control-label']) !!}
            <div class="col-sm-6">
                {!! Form::date('ends_at', $booking->ends_at, ['class' => 'form-control']) !!}
